...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/legendofeng_logo.jpeg',
                  fit: BoxFit.cover,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/howToUse',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'howToUse')
              : NavBarPage(
                  initialPage: 'howToUse',
                  page: HowToUseWidget(),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: WexamWidget(
              no: params.getParam('no', ParamType.int),
              wordDay: params.getParam('wordDay', ParamType.String),
            ),
          ),
        ),
