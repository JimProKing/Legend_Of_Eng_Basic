...
import 'got_model.dart';
export 'got_model.dart';

class GotWidget extends StatefulWidget {
  const GotWidget({
    Key? key,
    int? level,
  })  : this.level = level ?? 1,
  ...
  @override
  _GotWidgetState createState() => _GotWidgetState();
}

class _GotWidgetState extends State<GotWidget> {
  late GotModel _model;
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              logFirebaseEvent('GOT_PAGE_backspace_ICN_ON_TAP');
